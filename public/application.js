...
var config = {
  apiOrigins: {
    production: 'https://rank-it-up.herokuapp.com/'
  }
};
...
var playerEvents = __webpack_require__(23);
var matchEvents = __webpack_require__(44);
...
var onReturn = function onReturn() {
  ui.returnMain();
};
...
var returnMain = function returnMain() {
  $('.menu').show();
  $('.players-section').hide();
  $('.standings-section').hide();
};
...
var playerApi = __webpack_require__(24);
var playerUi = __webpack_require__(25);

var onCreatePlayer = function onCreatePlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  playerApi.createPlayer(data).then(playerUi.createPlayerSuccess).catch(playerUi.createPlayerFailure);
};

var onGetPlayers = function onGetPlayers(event) {
  playerApi.getPlayers().then(playerUi.getPlayersSuccess).catch(playerUi.getPlayersFailure);
};

var onGetPlayersTwo = function onGetPlayersTwo(event) {
  playerApi.getPlayers().then(playerUi.getPlayersSuccessTwo);
};

var onUpdatePlayer = function onUpdatePlayer(event) {
  event.preventDefault();
  var data = getFormFields(this);
  playerApi.updatePlayer(data).then(playerUi.updatePlayerSuccess).then(function () {
    return onGetPlayers(event);
  }).catch(playerUi.updatePlayerFailure);
};

var onDeletePlayer = function onDeletePlayer() {
  var id = event.target.dataset.id;
  playerApi.deletePlayer(id).then(playerUi.deletePlayerSuccess).then(function () {
    return onGetPlayersTwo(event);
  }).catch(playerUi.deletePlayerFailure);
};

var onWinsDesc = function onWinsDesc() {
  playerApi.winsDesc().then(playerUi.getStandings).catch();
};

var playerHandlers = function playerHandlers() {
...
var winsDesc = function winsDesc() {
  return $.ajax({
...
var showPlayersTemplate = __webpack_require__(26);
var orderByWins = __webpack_require__(43);
...
var getPlayersSuccess = function getPlayersSuccess(data) {
  if (data.players.length === 0) {
    ...
    var showPlayers = showPlayersTemplate({ players: data.players });
    $('.allPlayers').html(showPlayers);
  }
};

var getPlayersSuccessTwo = function getPlayersSuccessTwo(data) {
  if (data.players.length === 0) {
    $('.menu').show();
    $('.players-section').hide();
  } else {
...
var updatePlayerSuccess = function updatePlayerSuccess() {
...
var deletePlayerSuccess = function deletePlayerSuccess() {
  $.toast({
...
var getStandings = function getStandings(data) {
  if (data.players.length === 0) {
    $.toast({
      text: 'Please create a player first.', // Text that is to be shown in the toast
      icon: 'error', // Type of toast icon
    ...
    var showByWins = orderByWins({ players: data.players });
...
module.exports = {
  ...
  getPlayersSuccessTwo: getPlayersSuccessTwo,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    <div class=\"player col-md-4\">\n      <li data-id=\""
    ...
    + "\" class=\"dropdown-toggle\"  data-toggle=\"dropdown\" style=\"margin:10px\">\n        "
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</p>\n        <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.wins : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "        </p>\n        <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.losses : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "        </p>\n        <li><a id=\"player-update-hover\" class=\"player-update\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#playerUpdate\">Update</a></li>\n        <li><a id=\"player-delete-hover\" class=\"player-delete\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</a></li>\n      </ul>\n    </div>\n\n";
  ...
  return "            Wins:  "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.wins : stack1), depth0))
    + "\n";
  ...
  return "            Losses:  "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.losses : stack1), depth0))
    + "\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <tr class=\"player-by-wins\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</td>\n            <td>"
...
var getFormFields = __webpack_require__(6);
// const store = ('./../store.js')
var matchApi = __webpack_require__(45);
var matchUi = __webpack_require__(46);

var onCreateMatch = function onCreateMatch(event) {
  event.preventDefault();
  var data = getFormFields(this);
  matchApi.createMatch(data).then(matchUi.createMatchSuccess).catch(matchUi.createMatchFailure);
};

var onListPlayers = function onListPlayers(event) {
  matchApi.listPlayers().then(matchUi.listPlayersSuccess).catch(matchUi.listPlayersFailure);
};

var matchHandlers = function matchHandlers() {
...
var createMatch = function createMatch(data) {
  return $.ajax({
...
var listChallengersTemplate = __webpack_require__(47);
var listOpposersTemplate = __webpack_require__(48);
var listWinnersTemplate = __webpack_require__(49);
var listLosersTemplate = __webpack_require__(50);

var createMatchSuccess = function createMatchSuccess(data) {
  $('#newMatch').modal('hide');
...
var createMatchFailure = function createMatchFailure() {
  $('.new-match-form').get(0).reset();
  $.toast({
    text: 'Please make sure to fill out both fields and try again.', // Text that is to be shown in the toast
    icon: 'error', // Type of toast icon
...
var listPlayersSuccess = function listPlayersSuccess(data) {
  $('.new-match-form').get(0).reset();
  if (data.players.length === 0) {
    $('#newMatch').modal('hide');
    $.toast({
    ...
    var listChallengers = listChallengersTemplate({ players: data.players });
    $('#newMatchChallenger').html(listChallengers);

    var listOpposers = listOpposersTemplate({ players: data.players });
    $('#newMatchOpposer').html(listOpposers);

    var listWinners = listWinnersTemplate({ players: data.players });
    $('#newMatchWinner').html(listWinners);

    var listLosers = listLosersTemplate({ players: data.players });
    $('#newMatchLoser').html(listLosers);
  }
};

var listPlayersFailure = function listPlayersFailure() {
  $.toast({
    text: 'We are unable to fetch your players at this time. Please try again later.', // Text that is to be shown in the toast
    icon: 'error', // Type of toast icon
    showHideTransition: 'slide', // fade, slide or plain
...
module.exports = {
  ...
  createMatchFailure: createMatchFailure,
  listPlayersSuccess: listPlayersSuccess,
  listPlayersFailure: listPlayersFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<option selected disabled>Challenger</option>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<option selected disabled>Opposer</option>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<option selected disabled>Winner</option>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<option selected disabled>Loser</option>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
